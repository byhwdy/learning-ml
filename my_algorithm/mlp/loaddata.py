...
if __name__ == '__main__':
	# print(get_training_data_set()[0]);
	# print(get_training_data_set()[1][:10])
	print(get_test_data_set()[0][1], get_test_data_set()[1][:3])